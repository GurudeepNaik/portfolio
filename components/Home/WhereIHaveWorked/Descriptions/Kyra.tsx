...
export default function Kyra() {
  const tasks = [
    {
      text: "Worked on the front-end development using Next.js, Tailwind CSS, Typescript and back-end using Node.js, Stripe, Docusign, Typescript, NetSuite, Share-point",
      keywords: [
        "Next.js",
        "Node.js",
        "Tailwind CSS",
      ...
      <div className="flex flex-col space-y-5 max-w-xl px-4 md:px-0">
        <div className="flex flex-col spacey-y-2">
          ...
          <span
            ...
            onClick={() => window.open("http://prlxweb.com/", "_blank")}
          >
            prlxweb.com
          </span>
        </div>
